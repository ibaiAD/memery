...
export function Menu ({ record, startStopGame }: Props) {
  return (
    <div>
      <p className="text-3xl sm:text-4xl text-center font-bold hover:text-purple-500 cursor-pointer hover:-translate-y-1 hover:scale-105 active:translate-y-0 transition-all"
